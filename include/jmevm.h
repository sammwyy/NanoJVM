...
/* Minimal .class parsing/execution (only enough for extracting a "main" method). */
...
/* Parses the class and executes the extracted main bytecode using the existing interpreter. */
